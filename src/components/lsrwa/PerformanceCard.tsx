  ...
  return (
    <div className="flex flex-col justify-between w-full h-[175px] border border-green bg-white rounded-[11px] shadow-[1px_3px_4px_0px_rgba(0,0,0,0.15)] p-[14px]">
      ...
      <div className='flex gap-1 h-[69px]'>
        <div className='flex flex-col items-start justify-center w-full h-full rounded-[6px] bg-[#F6F8F9]'>
          <p className='text-start font-medium leading-[30px] text-[#0A133999]'>Total Value Locked</p>
          <p className='text-start font-medium leading-[30px] text-[#0A133999]'>Current APR</p>
