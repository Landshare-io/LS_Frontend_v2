  ...
  return (
    <div className="sm:flex sm:items-start">
      <div className="text-center sm:text-left">
        <DialogTitle as="h3" className="text-base font-bold text-gray-900 text-[20px]">
          Deposit USDC to invest in income-generating real estate
        </DialogTitle>
        <div className="mt-[18px]">
          <p className="text-sm text-gray-500 text-[12px] font-semibold">
            Set Amount
          </p>
        </div>
        <div className="mt-[7px]">
          <div className='flex items-center'>
            <input type="number" className='focus:outline-none w-[200px] px-[18px] py-[23px] text-[18px]' value={amount} onChange={handleOnChange} />
            <button className='border-[1px] border-[#61CD81] px-[23px] py-[7px] rounded-full bg-[#E0F1E5] text-[#61CD81]' onClick={() => setAmountByPercent(0.25)}>25%</button>
            <button className='ml-[9px] border-[1px] border-[#61CD81] px-[23px] py-[7px] rounded-full bg-[#E0F1E5] text-[#61CD81]' onClick={() => setAmountByPercent(0.5)}>50%</button>
            <button className='ml-[9px] border-[1px] border-[#61CD81] px-[23px] py-[7px] rounded-full bg-[#E0F1E5] text-[#61CD81]' onClick={() => setAmountByPercent(1)}>100%</button>
          </div>
        </div>
        <div className="mt-2">
