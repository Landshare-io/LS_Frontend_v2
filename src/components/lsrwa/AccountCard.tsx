    ...
    <div className="flex flex-col justify-between w-full h-[175px] border border-green bg-white rounded-[11px] shadow-[1px_3px_4px_0px_rgba(0,0,0,0.15)] p-[14px]">
      ...
      <div className='flex justify-between w-full items-center'>
        <div className='text-start'>
          <p className='text-base leading-[22px] text-[14px] font-semibold'>Current<br/>Balance</p>
          <p className='text-base leading-[22px] text-[14px] font-semibold'>Available<br/>Yield</p>
        </div>
        <div className='text-center'>
          <div>
            <p className='text-[24px] font-bold leading-[30px]'>$ {isLoading ? 0 : deposited}</p>
            <p className='text-[14px] text-[#0A133999] font-medium leading-[22px]'>Currently Deposited</p>
          </div>
          <div>
            <p className='text-[24px] font-bold leading-[30px]'>$ {isLoading ? 0 : formatNumber(reward)}</p>
            <p className='text-[14px] text-[#0A133999] font-medium leading-[22px]'>Total earnings To date</p>
          </div>
          {reward > 0 &&
