export default function ReferralEarning() {
  return (
    <div className="lg:w-[543px] w-full h-fit flex flex-col bg-third rounded-2xl p-6 shadow-md">
      ...
      <button className="w-full font-bold border border-[#61CD81] opacity-60 text-text-primary text-sm mt-[22px] py-[13px] rounded-[100px]">
        Claim Earnings
      </button>
      ...
      <p className="text-sm mt-2 text-text-secondary leading-[22px]">
        ...
        <span className="text-[#61CD81] font-bold underline cursor-pointer">
          Learn more
        </span>
      </p>
