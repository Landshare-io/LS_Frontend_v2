    ...
    return (
        <main className="px-[10px] md:px-[66px] xl:px-[120px] py-10 md:py-[20px]">
            ...
            <div className="mt-4 md:mt-8">
                ...
                <p className="pt-[8px] text-text-secondary text-sm lg:text-start text-[14px] font-normal">Simply deposit USDC and earn real-world, asset-backed yield—<br/>no need to manually handle $LSRWA tokens.</p>
