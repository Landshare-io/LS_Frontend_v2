              ...
              <div className="flex flex-col justify-center p-0 gap-[16px]">
                ...
                <div className="grid grid-cols-2 gap-[12px] md:flex md:items-center md:justify-between p-0">
                  <div className="flex justify-between items-center py-[12px] px-[16px] w-full rounded-[12px] bg-vault-input">
                    ...
                    <span className={`text-[13px] leading-[22px] tracking-[0.02em] text-text-primary ${BOLD_INTER_TIGHT.className}`}>{"$" + abbreviateNumber(Number(tvl.toString().substr(0, 8)))}</span>
                  </div>
                  <div className="flex justify-between items-center py-[12px] px-[16px] w-full rounded-[12px] bg-vault-input">
                    ...
                    <div className="flex items-center gap-[4px] text-bold text-[14px] leading-[22px] text-[#0A0A0A]">
                      <span className={`text-[13px] leading-[22px] tracking-[0.02em] text-text-primary ${BOLD_INTER_TIGHT.className}`}>{isNaN(apr) ? "—" : abbreviateNumber(Number(Number(apr).toFixed(0))) + "%"}</span>
                      <button onClick={() => {
                        setShowModal(true)
                  ...
                  <div className="flex justify-between items-center py-[12px] px-[16px] w-full rounded-[12px] bg-vault-input">
                    ...
                    <span className={`text-[13px] leading-[22px] tracking-[0.02em] text-text-primary ${BOLD_INTER_TIGHT.className}`}>
                  ...
                  <div className="flex justify-between items-center py-[12px] px-[16px] w-full rounded-[12px] bg-vault-input">
                    ...
                    <Tooltip content={`Full number: ${formatEther(rewardLP || 0)}`}>
                      <span className={`text-[13px] leading-[22px] tracking-[0.02em] cursor-pointer text-text-primary ${BOLD_INTER_TIGHT.className}`}>{formatEther(rewardLP.toString()).substr(0, 5)}</span>
                    </Tooltip>
                  </div>
                </div>
              </div>
