              ...
              <div className="flex flex-col justify-center p-0 gap-[16px]">
                ...
                <div className="grid grid-cols-2 gap-[12px] md:flex md:items-center md:justify-between p-0">
                  <div className="flex justify-between items-center py-[12px] px-[16px] w-full rounded-[12px] bg-vault-input">
                    ...
                    <span className={`text-[13px] leading-[22px] tracking-[0.02em] text-text-primary ${BOLD_INTER_TIGHT.className}`}>{"$" + abbreviateNumber(Number(TVL))}</span>
                  </div>
                  <div className="flex justify-between items-center py-[12px] px-[16px] w-full rounded-[12px] bg-vault-input">
                  ...
                  <div className="flex justify-between items-center py-[12px] px-[16px] w-full rounded-[12px] bg-vault-input">
                    ...
                    <div className="d-flex align-items-center">
                      <span className={`text-[13px] leading-[22px] tracking-[0.02em] text-text-primary ${BOLD_INTER_TIGHT.className}`}>{userBalance ? Number(userBalance[0]) > 0 ? Number(formatEther(userBalance[0])).toExponential(2) : 0.0 : "0.0"} </span>
                    </div>
                  ...
                  <div className="flex justify-between items-center py-[12px] px-[16px] w-full rounded-[12px] bg-vault-input">
                    ...
                    <Tooltip content={`Full number: ${formatEther(rewardsLSRWALP || 0)}`}>
                      <span className={`text-[13px] leading-[22px] tracking-[0.02em] cursor-pointer text-text-primary ${BOLD_INTER_TIGHT.className}`}>{rewardsLSRWALP ? formatEther(rewardsLSRWALP).substr(0, 5) : "0.0"}</span>
                    </Tooltip>
                  </div>
                </div>
              </div>
