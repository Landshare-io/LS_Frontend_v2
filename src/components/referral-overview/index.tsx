    ...
    <div className="flex flex-col w-full bg-third rounded-2xl p-6 h-auto gap-8 md:gap-[29px] shadow-lg">
      ...
      <div className="flex justify-start gap-6">
        <div>
          ...
          <p className="font-bold text-lg text-text-primary leading-7">{pendingInvites - approvedInvites}</p>
        </div>
      ...
      <div className="w-full">
        ...
        <div className='flex justify-between items-center gap-6'>
          <Slider percentage = {20}/>

          <div className='w-20 shrink-0'>
            <p className='text-text-secondary text-base'>Earn Bonus</p>
            <p className='text-text-primary font-bold text-lg'>{referredVolume} USDC</p>
          </div>  
        </div>
