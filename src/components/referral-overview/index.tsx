...
export default function ReferralOverview (){
    ...
    <div className="flex flex-col lg:w-[617px] w-full bg-third rounded-2xl p-6 h-auto gap-8 md:gap-[29px] shadow-md">
        <div className="w-full flex justify-between">
            <p className="text-text-primary font-bold text-lg leading-7">Overview</p>
        ...
        <div className="flex justify-start gap-6">
            <div>
                <p className="text-sm text-text-secondary font-normal leading-7">Sign Ups</p>
                <p className="font-bold text-lg text-text-primary leading-7">0</p>
            </div>

            <div>
                <p className="text-sm text-text-secondary font-normal leading-7">Total Taker Volume</p>
                <p className="font-bold text-lg text-text-primary leading-7">0 USDT</p>
            </div>
        </div>
