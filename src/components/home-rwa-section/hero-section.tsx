          ...
          <div className="flex flex-col md:flex-row items-start md:justify-between md:items-center max-w-[1200px] m-auto">
            <div className="flex flex-col justify-end w-full whitespace-normal max-w-fit md:max-w-[560px]">
              ...
              <p className="line-clamp-4 mb-0 md:text-[16px] md:leading-[24px] md:tracking-[2%] lg:mb-[40px] lg:text-[18px] lg:leading-[28px] lg:tracking-[0.36px] text-[#535457] dark:text-[#a9abaf]">
                The Landshare RWA Token Main Sale is now live! Our new tokenization model offers a simple and secure way to gain exposure to real estate directly on-chain.
              </p>
              <div className="hidden md:flex gap-[16px]">
                ...
                <Link href="https://docs.landshare.io/platform-features/landshare-rwa-token-lsrwa">
                  <Button className="px-[24px] py-[13px] rounded-[100px] border-primary-green hover:bg-primary-green" textClassName="dark:text-[#fff]" outlined>Learn More</Button>
                </Link>
              </div>
            </div>
            ...
            <div className="mt-[20px] justify-around w-full flex flex-col gap-2 md:hidden">
              ...
              <a href="https://docs.landshare.io/platform-features/landshare-rwa-token-lsrwa">
                <Button className="rounded-[100px] py-[13px] w-full border-primary-green hover:bg-primary-greenhover:text-white" textClassName="dark:text-[#fff]" outlined>Learn More</Button>
              </a>
            </div>
          </div>
        </CarouselItem>
        <CarouselItem activeIndex={activeIndex}>
          <div className="flex flex-col md:flex-row items-start md:justify-between md:items-center max-w-[1200px] m-auto">
            <div className="flex flex-col justify-end w-full whitespace-normal max-w-fit md:max-w-[560px]">
              ...
              <p className="line-clamp-4 mb-0 md:text-[16px] md:leading-[24px] md:tracking-[2%] lg:mb-[40px] lg:text-[18px] lg:leading-[28px] lg:tracking-[0.36px] text-[#535457] dark:text-[#a9abaf]">
                Stay plugged in to Landshare by following our social media pages. Get the latest project updates, developer insights, industry news, and much more.
              </p>
              <div className="hidden md:flex gap-[16px]">
            ...
            <div className="mt-[20px] justify-around flex-col w-full flex gap-2 md:hidden">
              <Link href="https://linktr.ee/landshareio">
                <Button className="rounded-[100px] py-[13px] w-full bg-primary-green" textClassName="text-[#fff]">Link Tree</Button>
              </Link>
              <Link href="https://t.me/landshare">
                <Button className="rounded-[100px] py-[13px] w-full border-primary-green hover:bg-primary-green" textClassName="dark:text-[#fff]" outlined>Telegram</Button>
              </Link>
            </div>
          </div>
        </CarouselItem>
