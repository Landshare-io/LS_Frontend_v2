        ...
        <div className="flex justify-between items-start flex-col md:items-center lg:flex-row justify-around gap-[20px] lg:flex-row lg:gap-[80px] xxl:gap-[200px] pb-[40px]">
          ...
          <div className="w-full grid grid-cols-2 gap-y-[25px] mlg:gap-[20px] mlg:max-w-[600px] xl:basis-[50%] xl:grid-cols-4 xl:justify-between grow-[2]">
            <div className="p-0 flex flex-col gap-[16px]">
              <span className="font-normal text-[14px] leading-[22px] text-[#0A133999] dark:text-[#cbcbcb]">Company</span>
              <div className="flex flex-col gap-[24px] text-text-primary">
                <a href="https://landshare.io/about-us" className='font-normaml text-[14px] leading-[22px]'>About Us</a>
                <a href="https://landshare.io/faqs" className='font-normaml text-[14px] leading-[22px]'>FAQ</a>
                <a href="https://landshare.io/blog" className='font-normaml text-[14px] leading-[22px]'>Blog</a>
              </div>
            </div>
            <div className="p-0 flex flex-col gap-[16px]">
              <span className="font-normal text-[14px] leading-[22px] text-[#0A133999] dark:text-[#cbcbcb]">Useful Links</span>
              <div className="flex flex-col gap-[24px] text-text-primary">
                <a href="https://bscscan.com/token/0xa73164db271931cf952cbaeff9e8f5817b42fa5c" className='font-normaml text-[14px] leading-[22px]'>BSC Scan</a>
                <a href="https://landshare.medium.com/landshare-roadmap-q3-q4-2024-preview-630f74d736e7" className='font-normaml text-[14px] leading-[22px]'>Roadmap</a>

                <a href="https://track.swipelux.com/?api-key=1d1fe8ad-a154-4dc0-a6bd-3fe8939ba7d0" className='font-normaml text-[14px] leading-[22px]'>Buy with card</a>
              </div>
            </div>
            <div className="p-0 flex flex-col gap-[16px]">
              <span className="font-normal text-[14px] leading-[22px] text-[#0A133999] dark:text-[#cbcbcb]">Token Trackers</span>
              <div className="flex flex-col gap-[24px] text-text-primary">
                <a href="https://www.coingecko.com/en/coins/landshare" className='font-normaml text-[14px] leading-[22px]'>Coin Gecko</a>
                <a href="https://www.dextools.io/app/en/bnb/pair-explorer/0x13f80c53b837622e899e1ac0021ed3d1775caefa?t=1718065952090" className='font-normaml text-[14px] leading-[22px]'>DexTools</a>
                <a href="https://coinmarketcap.com/currencies/landshare/" className='font-normaml text-[14px] leading-[22px]'>CoinMarketCap</a>
              </div>
            </div>
            <div className="p-0 flex flex-col gap-[16px]">
              <span className="font-normal text-[14px] leading-[22px] text-[#0A133999] dark:text-[#cbcbcb]">Exchanges</span>
              <div className="flex flex-col gap-[24px] text-text-primary">
                <a href="https://pancakeswap.finance/swap?outputCurrency=0xA73164DB271931CF952cBaEfF9E8F5817b42fA5C" target="_blank" className='font-normaml text-[14px] leading-[22px]'>Pancake Swap</a>
                <a href="https://www.gate.io/trade/LAND_USDT" target="_blank" className='font-normaml text-[14px] leading-[22px]'>Gate.io</a>
                <a href="https://www.mexc.com/exchange/LANDSHARE_USDT" target="_blank" className='font-normaml text-[14px] leading-[22px]'>MEXC</a>
                <a href="https://www.bitmart.com/trade/en-US?symbol=LAND_USDT" target="_blank" className='font-normaml text-[14px] leading-[22px]'>BitMart</a>
              </div>
            </div>
          </div>
          <div className="flex flex-col basis-[25%] mt-[20px] md:mt-0">
            <div className="w-full flex gap-[10px] mb-[8px]">
              ...
              <span className="font-bold text-[16px] leading-[24px] text-text-primary">Our News Letter</span>
            </div>
            ...
            >
              ...
              <button type="submit">
                ...
                <Image src={IconArrowRight} className='w-[32px] h-[32px] bg-[#66CE85] rounded-[30px]' alt="arrow right" />
              </button>
            </form>
