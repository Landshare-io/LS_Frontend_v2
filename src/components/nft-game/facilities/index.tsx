...
export default function ProductionFacilities() {
  ...
  return (
    <>
      ...
      <div className="mb-5 hidden pb-[20px] md:grid md:grid-cols-[minmax(257px,max-content),minmax(257px,max-content)] justify-between gap-[50px] lg:md:grid-cols-[minmax(257px,max-content),minmax(257px,max-content),minmax(257px,max-content)]">
