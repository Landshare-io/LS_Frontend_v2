          ...
          <div className="flex flex-col md:flex-row gap-[16px] mt-[40px]">
            <a target="_blank" href="https://docs.landshare.io">
              <Button
                ...
                className="w-full md:w-auto px-[24px] py-[13px] bg-landshare-green rounded-[100px]"
              >
                View Docs
              </Button>
            </a>
            ...
            >
              <Button
                ...
                className="w-full md:w-auto px-[24px] py-[13px] border-landshare-green hover:bg-landshare-green  rounded-[100px]"
                outlined
              >
                Whitepaper
              </Button>
