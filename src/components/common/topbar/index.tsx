  ...
  return (
    <>
      <div className="w-full overflow-hidden px-2">
        <div className="flex flex-nowrap items-center mt-[10px] mb-[30px] overflow-x-auto">
          <span
          ...
          <span
            className={`relative mr-[20px] hover:text-normal hover:after:content-[""] hover:after:absolute hover:after:left-0 hover:after:bottom-[5px] hover:after:w-full hover:after:h-[6px] hover:after:bg-[#656565] hover:after:rounded-[10px] duration-300 pb-3 mr-[8px] pr-[2px] sm:mr-[20px] sm:pr-[5px] cursor-pointer after:ease-in-out ${theme == 'dark' ? "text-[#eaf3f3]" : "text-[#131414]"} ${pathName.includes("/marketplace") && `after:content-[""] after:absolute after:left-0 after:bottom-[5px] after:w-full after:h-[6px] after:bg-[#81db9b] after:rounded-[10px] ${BOLD_INTER_TIGHT.className}`
              }`}
          ...
          <span
            className={`relative mr-[20px] hover:text-normal hover:after:content-[""] hover:after:absolute hover:after:left-0 hover:after:bottom-[5px] hover:after:w-full hover:after:h-[6px] hover:after:bg-[#656565] hover:after:rounded-[10px] duration-300 pb-3 mr-[8px] pr-[2px] sm:mr-[20px] sm:pr-[5px] cursor-pointer after:ease-in-out ${theme == 'dark' ? "text-[#eaf3f3]" : "text-[#131414]"} ${pathName.includes("/resources") && `after:content-[""] after:absolute after:left-0 after:bottom-[5px] after:w-full after:h-[6px] after:bg-[#81db9b] after:rounded-[10px] ${BOLD_INTER_TIGHT.className}`
              }`}
