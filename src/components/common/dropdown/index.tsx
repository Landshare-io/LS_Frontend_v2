...
Dropdown.Toggle = function Toggle({ children, className, onClick }: { children: JSX.Element, className: string, onClick: React.MouseEventHandler<HTMLButtonElement> }) {
  return (
    <button
      onClick={onClick}
...
Dropdown.Menu = function Menu({ children, className }: { children: JSX.Element, className: string }) {
  return (
    <div className={`origin-top-right absolute right-0 mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-10 ${className}`}>
