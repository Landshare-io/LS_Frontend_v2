  ...
  return (
    <>
      <div className="bg-white py-4">
        <div className="max-w-[1200px] mx-auto w-75">
          <div className="flex justify-between">
            <div className="w-full lg:w-[25%]">
              <ul className="list-none text-start md:text-center">
                <li className="py-2 flex justify-center md:justify-start">
                  <img src={Logo} alt="Logo" />
                </li>
                <li className="py-2 flex justify-center md:justify-start">
                  <img src={Landshare} alt="" />
                </li>
                <li className="flex justify-start md:justify-center py-2">
                  <span>
                    <svg
                      className="duration-300 hover:translate-y-[-3px] cursor-pointer"
                      width="29"
                      height="29"
                      viewBox="0 0 29 29"
                      fill="none"
            ...
            <div className="w-full lg:w-[75%] mt-auto mx-auto items-center">
              <p className="w-full my-auto mb-1 text-[9px]">
              ...
              <p className="text-[14px] text-[#858585] max-w-[348px] text-center mx-auto pt-3">
                ©2024 Landshare LLC{" "}
              </p>
            </div>
            <div className="w-full lg:w-[30%] text-center flex justify-center items-center my-0 md:my-2"></div>
            <div className="w-full lg:w-[30%] flex justify-end md:justify-start items-end md:items-start"></div>
          </div>
        </div>
      </div>
      {/* GREEN FOOTER  */}
