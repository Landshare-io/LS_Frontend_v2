  ...
  return (
    ...
    >
      <div className='bg-primary'>
        <div className='text-text-primary p-3 text-[25px] font-medium text-[#000]'>
          {title}
        </div>
        <div className='px-3 pb-6'>
          <div className="flex flex-col mb-3 gap-[0.5rem]">
            <label htmlFor='text-text-primary mint-amount'>Extend Land Amount</label>
            <input 
              id="mint-amount"
              type="text"
              value={landAmount}
              ...
              min={minAmount}
              className='px-[0.75rem] py-[0.375rem] leading-[1.5] text-text-secondary bg-secondary border-[1px] border-[#ced4da] bg-[#fff] rounded-[0.25rem] duration-[150] transition-all ease-in-out'
            />
            {assetError && (
