...
import useIsWhitelistedAddressOfRwa from "../../../../hooks/contract/LandshareSaleContract/useIsWhitelistedAddress";
...
export default function KYCModal () {
    ...
    const {iskycmodal, setKycopen, handleclosemodal, isZeroIDModal, setZeroIDModalOpen} = useGlobalContext();
