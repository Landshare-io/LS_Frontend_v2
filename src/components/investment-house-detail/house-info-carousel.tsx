...
export default function HouseInfoCarouselComponent({
  ...
  return (
    <>
      {houseInfo?.address ? (
        <div className="max-w-[1200px] text-text-primary flex flex-col gap-2 md:gap-2 m-auto my-[10px] px-[10px] pb-[50px] ">
          <div className="flex flex-col ">
          ...
          {/* second section */}
          <div className="w-full md:gap-[28px] md:grid md:grid-cols-[35%_60%] flex flex-col ">
            ...
            <div className="justify-between flex flex-col h-[92.5%] gap-4 md:gap-0">
              <section className="flex flex-col gap-3">
          ...
          <section className="hidden md:flex lg:hidden flex-col gap-3">
            ...
            <Link href="/rwa">
              <Button
                className={`w-[165px] h-[44px] text-[#fff] rounded-[100px] bg-[#61cd81]`}
