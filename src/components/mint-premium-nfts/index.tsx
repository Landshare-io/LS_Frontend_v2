...
export default function PremiumNfts() {
  ...
  return (
    <div className="flex gap-[20px] overflow-x-auto pb-[10px] mb-[70px] mlg:grid mlg:grid-cols-[minmax(257px,max-content),minmax(257px,max-content)] md:justify-between mlg:gap-[4rem] lg:grid-cols-[minmax(257px,max-content),minmax(257px,max-content),minmax(257px,max-content)] my-5">
